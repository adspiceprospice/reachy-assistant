...
from hey_robo.vision.processors import (
    VisionConfig,
    VisionManager,
    VisionProcessor,
...
def mock_torch() -> Any:
    ...
    with patch("hey_robo.vision.processors.torch") as mock:
...
def mock_transformers() -> Any:
    ...
    with patch("hey_robo.vision.processors.AutoProcessor") as proc, \
         patch("hey_robo.vision.processors.AutoModelForImageTextToText") as model:
...
def test_vision_processor_initialization_failure(mock_torch: Any) -> None:
    ...
    with patch("hey_robo.vision.processors.AutoProcessor") as mock_proc:
...
def test_vision_processor_process_image_success(mock_torch: Any, mock_transformers: Any) -> None:
    ...
    with patch("hey_robo.vision.processors.cv2") as mock_cv2:
...
def test_initialize_vision_manager_success(mock_torch: Any, mock_transformers: Any, mock_camera: Mock) -> None:
    ...
    with patch("hey_robo.vision.processors.snapshot_download") as mock_download, \
         patch("hey_robo.vision.processors.os.makedirs"), \
         patch("hey_robo.vision.processors.config") as mock_config:
...
def test_initialize_vision_manager_processor_failure(mock_torch: Any, mock_camera: Mock) -> None:
    ...
    with patch("hey_robo.vision.processors.snapshot_download"), \
         patch("hey_robo.vision.processors.os.makedirs"), \
         patch("hey_robo.vision.processors.config") as mock_config, \
         patch("hey_robo.vision.processors.AutoProcessor") as mock_proc:
