...
from hey_robo.tools.background_tool_manager import (
    ToolCallRoutine,
    ToolNotification,
...
class OpenaiRealtimeHandler(AsyncStreamHandler):
    ...
    async def apply_personality(self, profile: str | None) -> str:
        ...
        try:
            ...
            from hey_robo.config import config as _config
    ...
    async def emit(self) -> Tuple[int, NDArray[np.int16]] | AdditionalOutputs | None:
        ...
        if self.idle_signals_enabled and idle_duration > 15.0 and self.deps.movement_manager.is_idle():
            try:
